			...
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" >
						...
						<ul class="nav navbar-nav menu_nav ml-auto" style="padding-top:30px">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
      ...
      <tr>
						...
						<div class="single-product">
							...
							<div class="product-details">
								...
								<g:link controller="grocery" action="marketdata"><h6 id="shopname">${it.cost}</h6></g:link>
