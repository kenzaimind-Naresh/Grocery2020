					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item submenu dropdown">
								...
								<ul class="dropdown-menu">
							<li class="nav-item"><a class="nav-link" href="/Skeleton/merchant/create">merchant singup</a></li>
								</ul>
							</li>
				...
				<div class="col-lg-6">
					<div class="login_box_img"> 
						...
						<div class="hover">
							...
							<a class="primary-btn" href="/Skeleton/merchant/create">Create an Account</a>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
