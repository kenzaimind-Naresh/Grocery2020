...
<div class="single-product" style="padding-left:20px">
	<a href="/Skeleton/address/create">
							
Full Name :${it.fullName}<br>
Mobile Number :${it.mobileNumber}<br>
H.No :${it.houseNumber}<br>
Area :${it.area}<br>
Land mark:${it.landmark}<br>
City:${it.city}<br>
Pin Code:${it.pincode}<br>
State:${it.state}<br>	
