...
<div class="fieldcontain ${hasErrors(bean: result.gInstance, field: 'cost', 'error')} required">
	...
	<g:textField name="cost" maxlength="50" required=""  id="cost" onchange="off()" class="form-control" value="${result.gInstance?.cost}"/>
...
<div class="fieldcontain ${hasErrors(bean: result.gInstance, field: 'offer', 'error')} required">
	...
	<g:textField name="offer" required="" id="offer" onchange="off()" class="form-control"  value="${ result.gInstance?.offer}"/>
...
<div class="fieldcontain ${hasErrors(bean: result.gInstance, field: 'total', 'error')} required">
	...
	<g:textField name="total" maxlength="50" required="" id="total" onchange="off()" readonly class="form-control"  value="${result.gInstance?.total}"/>
...
<%--</div></div>--%>
					...
					<g:actionSubmit class="saveupdate" action="saveupdate" class="btn btn-primary" value="${message(code: 'default.button.update.label', default: 'Update')}" />
				</fieldset>
				</div>
			</g:form>
		</div>
