					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item submenu dropdown active">
								<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
								 aria-expanded="false" style="color:black;">Signin</a>
								 <ul class="dropdown-menu">
			...
			<div class="row">
				...
				<div class="col-lg-5">
					<div class="content-heading" style="padding-bottom:20px;">
						<h3 style="text-align:center">Merchant Registration</h3>
...
<div class="fieldcontain ${hasErrors(bean: merchantInstance, field: 'password', 'error')} required">
	...
	<g:field type="password" name="password" class="form-control" id="password" required="" placeholder="Password" value="${merchantInstance?.password}"/>
