...
<g:form class="example" action="searchlocation" controller="merchant" method="GET" style="width:500px">			
  <div class="row">
  <input type="text" name="city" id="city" class="form-control"  placeholder="Search By Location.."> <br><br>
    <input type="text" name="street" id="street" class="form-control"  placeholder="Search By Colony..."><br><br>
  </div>
  <br>
