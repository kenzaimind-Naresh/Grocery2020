...
class TestController {
    ...
    def edit() {
		...
		def paytmpay2(custid,mobile,cEmail,tranAmount,orderid) {
...
//[values:values]
	...
	public String sendSMSToUser(String toNumber,String msg){
	...
	try {
			...
			log.info("Message data :receiver "+toNumber+": message "+message)
			// Send data
			HttpURLConnection conn = (HttpURLConnection) new URL("https://api.textlocal.in/send/?").openConnection();
			String data = apiKey + numbers + message + sender;
			conn.setDoOutput(true);
