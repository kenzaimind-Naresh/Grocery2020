...
<div class="container">
 ...
 <div class="container signin">
       <div class="row">
            <div class="col-xs-9 col-sm-6 col-md-4">
                <h4 style="font-family: Calibri">Packages List <b style="font-size:12px; color:black;">
                (No of Packages Created = ${result.totalcount })</b></h4>
            </div>
 ...
 <div class="table-responsive">
     ...
     <g:link type="button" style="color:white" controller="package" action="createpackage"  value="Create Package">
     <button class="genric-btn primary circle" style="font-size: 15px;">Create Package</button></g:link>
    </div><br><br>
