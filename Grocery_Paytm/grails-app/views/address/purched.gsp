...
img {
 ...
 <div class="container">
                   ...
                   <img src="img_chania.jpg" alt="Flowers in Chania" width="200" height="300"><br>
                   
                   <p style="padding-left:30px">Product Name:${result.data.ugroceryName} </p>
                          <p>Quantity:${result.data.uquantity} </p>
                              <p>Cost:${result.data.ucost} </p>
                                  <p>Weight:${result.data.uweight} </p>
                                    <p>Offer:${result.data.uoffer} </p>
                   
                                         <p>Total Amt:${result.data.utotal} </p>
