 ...
 <div id="wrapper">
  ...
  <g:render template="/user/aDashboard"/>
   <div>
        ...
        <input type="hidden" id="patientId" name="patientId" value="${responseData.pFirst.patientId}" >
         ...
         <div id="page-wrapper"><br><br><br>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <!-- Form Elements -->
                    <div class="page-header" align="center" style="color:black;font-size:20px">Op-Patient Information</div>
                </div></div>
           ...
           <input type="text" id="pFirstname" name="pFirstname" class="form-control" disabled value="${responseData.pFirst.pFirstname}" style="height:27px;width:260px;border-radius:5px" >
           <span id=pFirstnameinfo></span> </div></div>
           <div class="col-lg-6">
                 <div class="fieldgroup">  
           <label for="pLastname">LastName: </label>
           <input type="text" id="pLastname" name="pLastname" class="form-control" disabled value="${responseData.pFirst.pLastname}" style="height:27px;width:260px;border-radius:5px" >
           ...
           <div class="form-group">
            ...
            <input type="text" id="pAge" name="pAge" class="form-control" disabled value="${responseData.pFirst.pAge}" style="height:27px;width:260px;border-radius:5px">
            <span id=pAgeinfo></span></div></div>
             <div class="col-lg-6">
                 <div class="fieldgroup"> 
            <label for="pGender">Gender: </label>
            <input type="text" id="pGender" name="pGender" class="form-control" disabled value="${responseData.pFirst.pGender}" style="height:27px;width:260px;border-radius:5px">
           ...
           <div class="form-group">
            ...
            <input type="text" id="mobileNumber" name="mobileNumber" disabled class="form-control" value="${responseData.pFirst.mobileNumber}" style="height:27px;width:260px;border-radius:5px">
            <span id=mobileNumberinfo></span></div></div>
             <div class="col-lg-6">
                 <div class="fieldgroup"> 
            <label for="alternateMobile">AlternateMobile: </label>
            <input type="text" id="alternateMobile" class="form-control" disabled name="alternateMobile" value="${responseData.pFirst.alternateMobile}" style="height:27px;width:260px;border-radius:5px" >
           ...
           <div class="form-group">
            ...
            <input type="text" id="address" name="address" class="form-control" disabled value="${responseData.pFirst.address}" style="height:27px;width:260px;border-radius:5px">
            <span id=addressinfo></span></div></div>
             <div class="col-lg-6">
                 <div class="fieldgroup"> 
            <label for="pin">Pin Code: </label>
            <input type="text" id="pin" name="pin" class="form-control" disabled value="${responseData.pFirst.pin}" style="height:27px;width:260px;border-radius:5px" >
           ...
           <div class="form-group">
            ...
            <input type="text" id="fee" name="fee" class="form-control" disabled value="${responseData.pFirst.fee}" style="height:27px;width:260px;border-radius:5px" >
            <span id="feeinfo"></span></div></div>
            <div class="col-lg-6">
                 <div class="fieldgroup"> 
            <label for="email">Email: </label>
            <input type="text" id="email" name="email" class="form-control" disabled value="${responseData.pFirst.email}" style="height:27px;width:260px;border-radius:5px" >
      ...
      <div class="row">
           ...
           <div class="form-group">
            ...
            <input type="text" id="reference" name="reference" disabled class="form-control" value="${responseData.pFirst.reference}" style="height:27px;width:260px;border-radius:5px" >
            <span id=referenceinfo></span></div></div>
            <div class="col-lg-6">
                 <div class="fieldgroup">
            <label for="appointmentDate">AppointmentDate: </label>
            <input type="text" id="appointmentDate" name="appointmentDate" disabled class="form-control" width="120px" value="${responseData.pFirst.appointmentDate}" style="height:27px;width:260px;border-radius:5px" >
           ...
           <div class="form-group">
             ...
             <input type="text" id="appointmentTime" name="suninTimings" disabled class="form-control" value="${responseData.pFirst.appointmentTime}" style="height:27px;width:260px;border-radius:5px" >
            <span id=appointmentTimeinfo></span></div></div> 
            <div class="col-lg-6">
                 <div class="fieldgroup">       
            <label for="modifiedBy">ModifiedBy: </label>
            <input type="text" id="modifiedBy" name="modifiedBy" class="form-control" disabled value="${responseData.pFirst.modifiedBy}" style="height:27px;width:260px;border-radius:5px" >
