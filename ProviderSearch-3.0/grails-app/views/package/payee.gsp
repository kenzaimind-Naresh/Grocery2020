 ...
 <g:render template="/user/dDashboard"/>
       ...
       <div class="row">
            <div class="col-lg-12">
                ...
                <g:form class="form-horizontal" id="myform" name="myform" controller="package" method="post" action="paymentdo">
                 <div class="form-group">
                 <div class="col-sm-6">
            <label for="dFirstname1" style="padding-right:130px">FirstName: </label>
            <input type="text" id="dFirstname1" name="dFirstname1" class="form-control" disabled value="${result.uname.dFirstname }" />
         ...
         <div class="form-group">
            ...
            <input type="text" id="packName1" name="packName1" class="form-control" disabled value="${result.pack.packName }" />
            <span id=packNameinfo></span>
            </div></div>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="packPrice1" disabled name="packPrice1" value="${result.pack.packPrice }" />
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="phone1" name="phone1" disabled value="${result.uname.mobileNumber }"/>
  <span id="phoneinfo" style="color:red"></span>
    ...
    <input type="hidden" name="productinfo" value="test" > 
                      <input  type="hidden" name="email" id="email" value="nmandaloji@gmail.com"   />
                        <input  type="hidden" name="phone" id="phone" value="${result.uname.mobileNumber }"   />
                         <input  type="hidden" name="packName" id="packName" value="${result.pack.packName }"   />
                          <input  type="hidden" name="amount" id="amount" value="${result.pack.packPrice }"   />
                            <input  type="hidden" name="firstname" id="firstname" value="${result.uname.dFirstname }"   />
