...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li><a class="navbar-brand" class="active"<g:link controller="Doctor" action="createdoctor" class="active">Doctor Registration<span class="sr-only">(current)</span></g:link>></a></li>
     <li> <a class="navbar-brand" <g:link controller="inpatient" action="display" class="active">Inpatient Data</g:link>></a></li>
      </ul>
     </div>
 ...
 <p style="color:black;font-size:20px">Profile Updated Successfully</p>
