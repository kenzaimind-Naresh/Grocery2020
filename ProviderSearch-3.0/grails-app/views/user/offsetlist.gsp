    ...
    <div id="page-wrapper" align="center"><br><br>
          ...
          <div class="panel-body">
           ...
           <span id=patientIdinfo></span>
            ...
            <div align="center">
            <input type="submit" ID="btnsave" value="Search" class="submit" onclick="return validateForm()" onclick="return check()" style="height:35px;width:100px;border-radius:5px"/></tab64>
            </div></div>
