                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse navbar-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="/ProviderSearch/pharmacy/createpharmacy"><span>Register</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4 signin-pdtop">
                ...
                <g:form class="form-horizontal" role="form" controller="user" action="pharmacyvalidation">
