  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
     ...
     <li><a class="navbar-brand" <g:link controller="inpatient" action="createinpatient" >In-Patient</g:link>></a></li>
      <li class="active"><a class="navbar-brand" <g:link controller="drugs" action="addEditdrug" >Drugs</g:link>></a></li>
    ...
    <ul class="nav navbar-nav navbar-right">
      <li ><a class="navbar-brand" <g:link controller="user" action="userDashboard" ><span class="glyphicon glyphicon-home" style="color:red"></span> Home</g:link>></a></li>
    	...
    	<center><g:link controller="drugs" action="createdrugs"  class="active"><button type="button" align="center" class="btn btn-success btn-lg">Add a Drug</button></g:link></center>&nbsp;
	<center><g:link controller="drugs" action="updatedrugs" align="center" class="active"><button type="button" align="center" class="btn btn-success btn-lg">Edit a Drug</button></g:link></center>
