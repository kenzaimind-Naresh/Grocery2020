    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-12 doctor-form">
				...
				<g:form  class="form-inline " id="myform" name="myform" controller="donar" action="donarSearchinfo">
                    <div class="form-group">
                        <label class="sr-only" for="bloodgroup">Search by Bloodgroup</label>
                    ...
                    <div class="form-group">
                        <label class="sr-only" for="city">Search by Place</label>
                        <input type="text" class="form-control" id="city1" name="city1" placeholder="Search by Place">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4 col-sm-4 col-md-4">
                        ...
                        <div class="doctor-title">
					 	 ...
					 	 <h4>${i.d_firstname} ${i.d_lastname}</h4>
                        </div>
