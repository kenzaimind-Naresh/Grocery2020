...
<div class="container">
	<div class="row" style="margin-right: 300px; font-size: 10px;">
		<div class="col-xs-12 col-sm-12 col-md-10 col-md-offset-1 signin-pdtop">
			<div class="form-group">
				...
				<div class="col-md-7 col-sm-7">
					...
					<div class="col-md-5 col-sm-5">
						<b style="font-size: 17px;">Amul Icecreams&nbsp;</b><br>
						Weekly Bazar, Armoor,&nbsp;
						Telangana-505325.<br>
					</div>
					<table align="right">
			...
			<div class="form-group">
				<div class="col-md-7 col-sm-7">
					 <b style="background-color:#b8b4b4;font-size: 15px;">Customer Details &emsp;&emsp;</b><br>
					 <b>Name: </b>${result.PInstance1.customerName} &nbsp;
					 <b>Mobile: </b>${result.PInstance1.mobileNumber } &nbsp;
					 <b>Address: </b> ${result.PInstance1.address }<br>
				 </div>
			</div>
			<div class="form-group">
				<div class="col-md-7 col-sm-7">
		    ...
		    <div class="form-group">
			    ...
			    <div class="form-group">
					<div class="col-md-7 col-sm-7"> 
			   			<div align="center">
			     			<input type="button" class="btn btn-primary hidden-print"  value="Print Invoice" onclick="PrintElem('#mydiv')" />
						</div>
					</div>
				</div>
			</div>
