...
<!--  &nbsp;&nbsp;<input type="button" value="Print" onclick="window.print()" />-->
  ...
  <tr>
<td>
<g:if test="${billingInstance?.createDate}">
...
<td style="font-size:20px"><font color="skyblue"><span class="property-value" aria-labelledby="createDate-label"><g:fieldValue bean="${billingInstance}" field="createDate" /></span></font></td>
</span>
</div>
</g:if>
</td>
...
<tr>
<td>
<g:if test="${billingInstance?.pFirstname}">
...
<td style="font-size:20px"><font color="skyblue"><span class="property-value" aria-labelledby="pFirstname-label"><g:fieldValue bean="${billingInstance}" field="pFirstname"/></span></font></td>
...
<tr>
<td>
<g:if test="${billingInstance?.jewelleryName}">
<div class="fieldcontain" align="center">
<span style="font-size:17px">
...
<td style="font-size:20px"><font color="skyblue"><span class="property-value" aria-labelledby="jewelleryName-label"><g:fieldValue bean="${billingInstance}" field="jewelleryName" /></span></font></td>
</span>
</div>
</g:if>
</td>
...
<tr>
<td>
<g:if test="${billingInstance?.ggrams}">
<div class="fieldcontain" align="center">
<span style="font-size:17px">
<span id="grams-label" class="property-label"><g:message code="gold.ggrams.label" default="Weight:" /></span>

<td style="font-size:20px"><font color="skyblue"><span class="property-value" aria-labelledby="ggrams-label"><g:fieldValue bean="${billingInstance}" field="ggrams"/></span></font></td>
...
<tr>
<td>
<g:if test="${billingInstance?.tax}">
<div class="fieldcontain" align="center">
<span style="font-size:17px">
<span id="tax-label" class="property-label"><g:message code="gold.tax.label" default="S.GST:" /></span>

<td style="font-size:20px"><font color="skyblue"><span class="property-value" aria-labelledby="tax-label"><g:fieldValue bean="${billingInstance}" field="tax"/></span></font></td>
...
<tr>
<td>
<g:if test="${billingInstance?.tax1}">
<div class="fieldcontain" align="center">
<span style="font-size:17px">
<span id="tax1-label" class="property-label"><g:message code="gold.tax1.label" default="C.GST:" /></span>

<td style="font-size:20px"><font color="skyblue"><span class="property-value" aria-labelledby="tax-label"><g:fieldValue bean="${billingInstance}" field="tax1"/></span></font></td>
...
<tr>
<td>
<g:if test="${billingInstance?.grandTotal}">
<div class="fieldcontain" align="center">
<span style="font-size:17px">
<span id="grandTotal-label" class="property-label"><g:message code="gold.grandTotal.label" default="Grand Total:" /></span>

<td style="font-size:20px"><font color="skyblue"><span class="property-value" aria-labelledby="grandTotal-label"><g:fieldValue bean="${billingInstance}" field="grandTotal"/></span></font></td>
...
<tr>
<td>
<g:if test="${billingInstance?.pMode}">
<div class="fieldcontain" align="center">
<span style="font-size:17px">
<span id="grandTotal-label" class="property-label"><g:message code="gold.grandTotal.label" default="Mode:" /></span>

<td style="font-size:20px"><font color="skyblue"><span class="property-value" aria-labelledby="grandTotal-label"><g:fieldValue bean="${billingInstance}" field="pMode"/></span></font></td>
