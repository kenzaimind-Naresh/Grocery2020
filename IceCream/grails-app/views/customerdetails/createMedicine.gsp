...
<h1>
<b style="color:Black">CreateMedicine</b>
</h1>
</section><br>
<div class="container">
<div class="row">
<div class="col-xs-12 col-sm-12 col-md-10 col-md-offset-1 signin-pdtop">
 ...
 <a href="/MedicalCare/Createmedicine/medicineviewlist"  style="font-size: 20px;color:skyblue">Medicine List</a>
...
<g:form class="form-horizontal" role="form" controller="Createmedicine" Id="myform" name="myform" action="saveMedicine"  nonvalidate="nonvalidate">
...
<input type="text" id="retailPrice" name="retailPrice" class="form-control" />
...
<input type="text" id="mQuantity" name="mQuantity" class="form-control" />
...
<input type="text" id="totalAvailable" name="totalAvailable" class="form-control" />
