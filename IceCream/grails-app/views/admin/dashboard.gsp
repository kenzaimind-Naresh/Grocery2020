...
<%--<div id="bg">
<img src="/Icecreams/images/arun icecreams logo.jpg" class="tm-logo" style="padding-left:0px ; height: 50px; width: 200px;"/>
</div>
...
<div class="message" role="status">${flash.message}</div>
      ...
      <%--<div align="center">
       ...
       <h1 style="color:red;font-weight: bold;">KENZAI JEWELLERS</h1>
    ...
    <g:form action="search" controller="User" method="GET">
        <div class="fieldcontain">
            ...
            <input type="text" name="jewelleryName" id="jewelleryName" placeholder="search for jewellery" required>
      ...
      --%><br><br><br><br>
       ...
       <div  class="container-fluid" style="padding-right: 50px; position:Absolute; margin-left: 620px"  align="center">                       
               
              <div class="col-xl-2 col-sm-12" align="center" style="paddin-right:500px;">
              <div class="card text-white bg-primary o-hidden h-100">
               ...
               <a class="card-footer text-white clearfix small z-1" href="/Icecreams/icecream/createicecream" target="_self"  >
                  <span class="float-left" style="font-weight: bold;">Create Icecream</span>
            ...
            <div class="col-xl-2 col-sm-12" align="center" style="paddin-right:500px;">
              <div class="card text-white bg-success o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" href="/Icecreams/admin/customerlist" target="_self">
                  <span class="float-left">Customers Report </span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
                </a>
                    ...
                    <br><br><br><br><br><br>
                    <h4><strong>Stock Details</strong></h4><br>
              ...
              <div class="card text-white bg-primary o-hidden h-100">
               ...
               <a class="card-footer text-white clearfix small z-1" href="/Icecreams/admin/stocksold" target="_self"  >
                  <span class="float-left" style="font-weight: bold;">Stock Sold</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
                </a>
              ...
              <div class="card text-white bg-primary o-hidden h-100">
               ...
               <a class="card-footer text-white clearfix small z-1" href="/Icecreams/admin/stockavail" target="_self"  >
                  <span class="float-left" style="font-weight: bold;">Available Stock</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
                </a>
