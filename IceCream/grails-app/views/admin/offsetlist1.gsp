...
<br>
			...
			<thead>
					<tr>
					<g:sortableColumn property="createdDate" title="${message(code: 'gold.createdDate.label', default: 'Date')}"/>
					<g:sortableColumn property="productDesc1" title="${message(code: 'gold.productDesc1.label', default: 'ProductDescription')}"/>	
					<g:sortableColumn property="weight1" title="${message(code: 'gold.weight1.label', default: 'Weight')}"/>
	      			<g:sortableColumn property="quantity1" title="${message(code: 'gold.quantity1.label', default: 'Quantity')}"/>
		      		<g:sortableColumn property="paymentMode" title="${message(code: 'gold.paymentMode.label', default: 'Payment Mode')}"/>
		...
		<td>${fieldValue(bean: goldInstance, field: "weight1")}</td>
		...
		<td>${fieldValue(bean: goldInstance, field: "createDate")}</td>		
		<td>${fieldValue(bean: goldInstance, field: "productDesc2")}</td>
		<td>${fieldValue(bean: goldInstance, field: "weight2")}</td>
		<td>${fieldValue(bean: goldInstance, field: "quantity2")}</td>
		<td>${fieldValue(bean: goldInstance, field: "paymentMode")}</td>			
					</tr>
				</g:each>
		...
		<td>${fieldValue(bean: billingInstance, field: "weight1")}</td>
		...
		<td>${fieldValue(bean: billingInstance, field: "createDate")}</td>	
		<td>${fieldValue(bean: billingInstance, field: "productDesc2")}</td>
		<td>${fieldValue(bean: billingInstance, field: "weight2")}</td>
		<td>${fieldValue(bean: billingInstance, field: "quantity2")}</td>
		<td>${fieldValue(bean: billingInstance, field: "paymentMode")}</td>
