...
<ul class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
 ...
 <!-- Navbar -->
      <ul class="navbar-nav ml-auto ml-md-0">
        <li class="nav-item">
       <a  class="nav-link"  href="/SalesAndServicesApp/admin/dashboard">
...
<input type="text" id="sellQuantity" name="sellQuantity" class="form-control"  />
...
<input type="text" id="cPrice" name="cPrice" class="form-control" />
 <span id="cPriceinfo" style="color:red"></span>
</div>
