...
<body>
<a class="navbar-brand" href="/MedicalCare/user/userlogin" >MedicalCare</a>
<ul class="nav navbar-top-links navbar-left">
<li class="divider"></li>
<li><a href="/MedicalCare/"><i class="fa fa-home fa-fw" style="font-size:40px;color:Black;" ></i></a>
                        </li>
...
<div class="row">               
 ...
 <div class="table-responsive">
  ...
  <tr class="fieldgroup">
      ...
      <td style="color:black"><b>percentage:</b></td>
      <td style="color:black">${result.customerdetailsInstance.percentage}</td>
     </tr>
