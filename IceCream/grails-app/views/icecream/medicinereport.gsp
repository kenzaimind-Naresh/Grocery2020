...
<a class="navbar-brand" href="/MedicalCare/user/userdashboard1" >Nagaraju Jewellers</a>
...
<h1>
<b style="color:Black">Gold  Report</b>
</h1>
<br>
</section>
    ...
    <tr><th>Create Date</th><th>Jewellery Name</th><th>Total</th><th>Available</th><th>Created By</th></tr>
    <g:each in="${createmedicineInstanceList}" status="i" var="createmedicineInstance">
    <tr  class="${(i % 2) == 0 ? 'even' : 'odd'}"><td>${fieldValue(bean: createmedicineInstance, field: "createDate")}</td>
    <td>${fieldValue(bean: createmedicineInstance, field: "medicineName")}</td>
    
        <td>${fieldValue(bean: createmedicineInstance, field: "total")}</td>
...
<p>Copyright © 2019. Kenzaimind Info Solutions</p>
