...
<a class="navbar-brand" href="/MedicalCare/user/userdashboard1" >Nagaraju Jewellars</a>
...
<div align="center">
<h3>Nagaraju Jewellery</h3>
 <p style="color:black;font-size:20px">  Bill  Generated Successfully</p><br>
</div>
<!--  &nbsp;&nbsp;<input type="button" value="Print" onclick="window.print()" />-->

  <div id="mydiv">
    <table align=center style="border: thick solid black;width:1000px;height:60px;">
    <col width="200">
    <col width="200">
    <col width="150">
    <col width="200">
  ...
  <tr class="fieldgroup">
      ...
      <td><b>Mobile Number:</b></td><td> ${result.PInstance1.mobileNumber }</td>
      <td><b>SaleGoldRate:</b></td><td> ${result.PInstance1.salegoldrate }</td>
    ...
    <!--  <table align="center"> -->
     ...
     <td bgcolor="green"><font color="black"><b>GoldWeight(g)</b></td>
     <td bgcolor="green"><font color="black"><b>Tunch(%)</b></td>
     <td bgcolor="green"><font color="black"><b>SalePurity</b></td>
     <td bgcolor="green"><font color="black"><b>Gold Rate(g/11.664)</b></td>
      ...
      <td>${result.PInstance1.grams}</td>
      <td>${result.PInstance1.goldpercentage	}</td>
      
      <td>${result.PInstance1.salepurity 	}</td>
      <td>${result.PInstance1.priceofgold}</td>
      ...
      <td></td> 
      <td><b>Tax:</b></td>
      <td>${result.PInstance1.tax}</td></tr>
      ...
      <td>${result.PInstance1.grandTotal}</td></tr>
      ...
      <td></td> 
      <td><b>Q.Total:</b></td>
      <td>${result.PInstance1.qtotal}</td></tr>
  ...
  <p><strong>Note: </strong> Including All Taxes & Gst</p>
   ...
   <div align="center">
     <input type="button" class="btn btn-primary" value="Print Div" onclick="PrintElem('#mydiv')" />
</div>
