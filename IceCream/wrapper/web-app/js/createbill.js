...
$(document).ready(function(){
   ...
   function validateForm() {
	 ...
	 var grandTotal = document.forms["myform"]["grandTotal"].value;
	    ...
	    if (productDesc1 == null || productDesc1.trim() == "" || productDesc1.match('^[a-zA-Z\ \]{3,30}$') == null) {
		    document.getElementById('productDesc1info').style.display = 'inline';	
	    	 $("#productDesc1info").text("Please Enter Product Description");	
	    	 return false;
		    	 }
	    if (weight1 == null || weight1.trim() == "" || weight1.match('^[0-9]+$' ) == null) {
	    ...
	    if (productDesc2 == null || productDesc2.trim() == "" || productDesc2.match('^[a-zA-Z\ \]{3,30}$') == null) {
		    document.getElementById('productDesc2info').style.display = 'inline';	
	    	 $("#productDesc2info").text("Please Enter Product Description");	
	    	 return false;
		    	 }
	    if (weight2 == null || weight2.trim() == "" || weight2.match('^[0-9]+$' ) == null) {
	    ...
	    if (productDesc3 == null || productDesc3.trim() == "" || productDesc3.match('^[a-zA-Z\ \]{3,30}$') == null) {
		    document.getElementById('productDesc3info').style.display = 'inline';	
	    	 $("#productDesc3info").text("Please Enter Product Description");	
	    	 return false;
		    	 }
	    if (weight3 == null || weight3.trim() == "" || weight3.match('^[0-9]+$' ) == null) {
	    ...
	    if (productDesc4 == null || productDesc4.trim() == "" || productDesc4.match('^[a-zA-Z\ \]{3,30}$') == null) {
		    document.getElementById('productDesc4info').style.display = 'inline';	
	    	 $("#productDesc4info").text("Please Enter Product Description");	
	    	 return false;
		    	 }
	    if (weight4 == null || weight4.trim() == "" || weight4.match('^[0-9]+$' ) == null) {
	    ...
	    if (productDesc5 == null || productDesc5.trim() == "" || productDesc5.match('^[a-zA-Z\ \]{3,30}$') == null) {
		    document.getElementById('productDesc5info').style.display = 'inline';	
	    	 $("#productDesc5info").text("Please Enter Product Description");	
	    	 return false;
		    	 }
	    if (weight5 == null || weight5.trim() == "" || weight5.match('^[0-9]+$' ) == null) {
