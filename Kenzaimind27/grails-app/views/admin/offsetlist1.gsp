...
<body>
 ...
 <div class="table-responsive">
     ...
     <g:link type="button" style="color:white" controller="admin" action="offsetlist1" params="${[offset:result.offset-5,mode:'web']}" value="Previous"><button class="primary-btn">Previous</g:link></button>
    </g:if>
