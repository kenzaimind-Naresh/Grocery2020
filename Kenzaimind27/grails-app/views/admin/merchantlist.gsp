...
<g:render template="/admin/adminhearder1"/>
 ...
 <div class="table-responsive">
     ...
     <g:link type="button" style="color:white" controller="admin" action="offsetlist" params="${[offset:result.offset-5,mode:'web']}" value="Previous"> <button class="-btnary-btn">Previous</g:link></button>
    </g:if>
