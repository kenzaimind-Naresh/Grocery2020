    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-10 col-md-offset-1 signin-pdtop">
                ...
                <g:form class="form-horizontal" role="form" controller="doctor" Id="myform" name="myform" action="savedoctor"  enctype="multipart/form-data" nonvalidate="nonvalidate">
				...
				<div class="col-md-4 col-sm-4">
                    ...
                    <input type="hidden" id="mode" name="mode" value="web">
                     <input type="hidden" id="alternateMobile" name="alternateMobile" value="NA">
