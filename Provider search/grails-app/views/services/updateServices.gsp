...
<g:render template="/user/header"/>
         <g:form controller="services" align="center" ID="myform" action="saveServices"  nonvalidate="nonvalidate"> 
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <!-- Form Elements -->
                    <div class="page-header"  style="color:black;font-size:20px;">Edit Services</div>
                </div></div>
            ...
            <div align="center">
            <input type="submit" ID="btnsave" value="Update" class="btn btn-primary" onclick="return validateForm()" style="height:35px;width:100px;border-radius:5px"/></tab64>
            </div></div>
    </div></div></div></div></div>
