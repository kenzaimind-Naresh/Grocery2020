 ...
 <g:render template="/user/aDashboard"/>
  <div class="container signin">
       <div class="row">
         ...
         <g:form class="form-horizontal" controller="package" id="myform" action="savepackage"  nonvalidate="nonvalidate"> 
            <div class="form-group">
             <div class="col-md-4 col-sm-4">
            <label>PackName: </label>
            <input type="text" id="packName" name="packName" class="form-control" />
            ...
            <input type="text" id="packPrice" name="packPrice" class="form-control"  />
            ...
            <div align="center">
            <input type="submit" ID="btnsave" value="Save" onclick="return validateForm()" class="btn btn-primary" style="height:30px;width:80px;border-radius:5px" />
           </div></g:form></div></div></div></div>
