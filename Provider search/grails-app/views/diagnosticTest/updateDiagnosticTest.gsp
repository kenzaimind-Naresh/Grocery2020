...
$(document).ready(function(){
	...
	$("#testName").focusout(function(){
		 ...
		 if ( $("#testName").val().trim().match('^[a-zA-Z\ \]{3,30}$')!=null && $("#testName").val().trim()!="") {
	...
	if (testName == null || testName.trim() == "" || testName.match('^[a-zA-Z\ \]{3,30}$') == null) {
         ...
         <g:form controller="diagnosticTest" align="center" ID="myform" action="saveDiagnosticTest"  nonvalidate="nonvalidate"> 
           <div id="page-wrapper" align="center"><br><br>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <!-- Form Elements -->
                    <div class="page-header"  style="color:black;font-size:20px;">Edit DiagnosticTest</div>
                </div></div>
            ...
            <div align="center">
            <input type="submit" ID="btnsave" value="Update" class="btn btn-primary" onclick="return validateForm()" style="height:35px;width:100px;border-radius:5px" />
            </div></div>
