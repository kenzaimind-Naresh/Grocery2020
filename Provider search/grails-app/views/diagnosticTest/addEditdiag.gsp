 ...
 <nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
     ...
     <li class="active"><a class="navbar-brand" <g:link controller="diagnosticTest" action="addEditdiag" >Diagnostic Test</g:link>></a></li>
	...
	<center><g:link controller="diagnosticTest" action="createDiagnosticTest"  class="active"><button type="button" align="center" class="btn btn-success btn-lg">Add a Test</button></g:link></center>&nbsp;
	
	<center><g:link controller="diagnosticTest" action="updateDiagnosticTest" align="center" class="active"><button type="button" align="center" class="btn btn-success btn-lg">Edit a Test</button></g:link></center>
