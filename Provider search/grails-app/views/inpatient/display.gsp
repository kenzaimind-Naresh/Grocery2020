...
<div id="wrapper">
 ...
 <div align="center"><b>In-Patient Data</b></div><br><br>
  <div class="row">
 ...
 <div class="table-responsive">
    ...
    <g:if test="${responseData.offset/5 < (responseData.totalcount)/5-1}">
     <button style="height:35px;width:100px;border-radius:5px"> <g:link type="button" controller="inpatient" action="offsetlist"   params="${[offset: responseData.offset+5]}" value="Next" style="height:35px;width:100px;border-radius:5px">Next</g:link></button>
       </g:if>
