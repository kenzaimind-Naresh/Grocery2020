...
<div id="wrapper">
 ...
 <div align="center"><b>Diagnostic Bill</b></div>
  <div class="row">
                <div class="col-lg-12">
                    <!-- Form Elements -->
 ...
 <br>
  ${responseData.solrresult.solrdata.date[0]}
 <br><br>
 <div class="table-responsive">
      ...
      <g:findAll controller="testdata" action="solr" in="${responseData.solrresult.solrdata}" expr="true">
     <tbody>
      <tr>
      <td>${it.id}</td>
       <td>${it.date }</td>
 ...
 <br>
  <p align="center" >
     ...
     <button style="height:35px;width:100px;border-radius:5px"><g:link type="button" controller="testData" action="searchof" params="${[eDate:responseData.date,offset:responseData.offset-5]}" value="Previous">Previous</g:link></button>
    </g:if>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  
    <g:if test="${responseData.offset/5 < (responseData.solrresult.size)/5-1}">
     <button style="height:35px;width:100px;border-radius:5px"> <g:link type="button" controller="testData" action="searchof"   params="${[eDate:responseData.date,offset:(responseData.offset+5)]}" value="Next" style="height:35px;width:100px;border-radius:5px">Next</g:link></button>
       </g:if>
       </p>
 </div></div>
</body>
