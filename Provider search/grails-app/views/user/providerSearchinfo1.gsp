...
$(function() {
	var x='${result.buttonId}'
	 document.getElementById(x).style.backgroundColor = '#27AE60';
	 document.getElementById(x).style.color = '#27AE60'
 ...
 %>
			...
			<div class="paging" align="right">
				...
				<ul class="page-mid2" >
					...
					<li id="one" style="color: blue"><g:link controller="user" action="providerSearchinfo" params="${[city:result.city,speciality:result.speciality,dGender:result.gender]}">1</g:link></li>
					<li id="two" style="color: blue"><g:link controller="user" action="providerSearchinfo1" params="${[city:result.city,speciality:result.speciality,dGender:result.gender,start:10,buttonId:'two']}">2</g:link></li>
