...
<div class="container signin">
    ...
    <div class="row">
         ...
         <g:form class="form-horizontal" controller="user" id="myform" action="passwordSave"  nonvalidate="nonvalidate"> 
        
	<input type="hidden" name="pass" Id="pass" value="${result.user.password}" />
           ...
           </div></div></g:form></div></div></div></div>
