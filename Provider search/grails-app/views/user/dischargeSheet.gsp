...
<g:render template="/user/header"/>
   <g:form  controller="user" align="center" Id="myform" name="myform" action="dischargeSheet1" method="POST" nonvalidate="nonvalidate">
           ...
           <span id=patientIdinfo></span>
            ...
            <div align="center">
            <input type="submit" ID="btnsave" value="Search" class="btn btn-primary" onclick="return validateForm()" onclick="return check()" style="height:35px;width:100px;border-radius:5px"/></tab64>
            </div></div>
