            ...
            <div class="navbar navbar-default navbar-fixed-top" role="navigation" id="navbar">
                <div class="container">
                    <div class="pull-right">
                        <ul class="loginbar pull-right">
                            <li><a href="/ProviderSearch/user/pharmacyDashboard">Home</a></li>
                            <li class="topbar-devider"></li>
                            <li><a href="/ProviderSearch/user/pharmacyDashboard">Dashboard</a></li>
                ...
                <div class="container">
                    <div class="navbar-header dash">
                        <a class="navbar-brand" href="/ProviderSearch/user/pharmacyDashboard">
                            <img src="/ProviderSearch/website/img/provider-logo.png" class="tm-logo" /></a>
                        <ul class="nav navbar-nav navbar-right">
                            <li class="dropdown pull-right">
                                <a class="dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="false"><span class="username-md">${result.uname.firstname }</span> <i class="fa fa-user"></i>
                                </a>

                                <ul class="dropdown-menu dropdown-user">
                                    <li><span class="username-sm">${result.uname.firstname }</span></li>
                                    <li class="divider"></li>
                                    <li><a href="/ProviderSearch/pharmacy/updatepharmacy"><i class="fa fa-user fa-fw"></i>User Profile</a></li>
                                    <li><a href="/ProviderSearch/pharmacy/changePass2"><i class="fa fa-lock fa-fw"></i>Change Password</a></li>
                                    <li class="divider"></li>
                                    <li><a href="/ProviderSearch/user/plogout"><i class="fa fa-sign-out fa-fw"></i>Logout</a>
                                    </li>
                                </ul>
                            </li>
    ...
    <div class="container signin-pdtop">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <li><g:link controller="pharmacy" action="createavailability" >Create Drug</g:link></li>
                
                
                <!--   <li><g:link controller="package" action="#" >Activation</g:link></li> -->
                </ul>
            </div>
        </div>
