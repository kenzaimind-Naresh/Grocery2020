...
<g:render template="/user/header"/>
         <g:form controller="drugs" align="center" ID="myform" action="savedrugs"  nonvalidate="nonvalidate"> 
            ...
            <input type="text"  name="drugName" id="drugName"  class="form-control" style="height:27px;width:205px;border-radius:5px"  onfocusout="getdata()"/>
            ...
            <input type="text" id="rate"  class="form-control"  name="rate" style="height:27px;width:205px;border-radius:5px">
